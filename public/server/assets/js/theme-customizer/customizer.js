...
$(document).ready(function () {
     ...
     $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "{{URL::to('/') }}/server/assets/css/"+color+".css" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', '{{URL::to('/') }}/server/assets/images/logo/logo.png');
