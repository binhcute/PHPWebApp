...
<div class="col-sm-12">
  ...
  <div class="card">
    ...
    @endif
    <form class="form theme-form" action="{{ route('NhaCungCap.update',$portfolio->id)}}" method="post" enctype="multipart/form-data">
      @csrf
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                <input class="form-control" type="text" placeholder="Nhập tên Nhà Cung Cấp" name="name" value="{{$portfolio ->name}}">
              </div>
            </div>
            <div class="mb-3 row">
              <label class="col-sm-3 col-form-label">Chi Tiết</label>
              <div class="col-sm-9">
                <textarea class="form-control" rows="5" cols="5" placeholder="Nội dung chi tiết..." name="detail">{{$portfolio->detail}}</textarea>
              </div>
            </div>
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                ...
                <img src="{{URL::to('/') }}/server/assets/images/portfolio/{{ $portfolio->img }}" alt="">
            <label for="img">{{$portfolio->img}}</label> 
              </div>
            </div>
          </div>
        </div>
