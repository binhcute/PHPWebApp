...
<div class="col-sm-12">
  ...
  <div class="card">
    ...
    @endif
    <form class="form theme-form" action="{{ route('NhaCungCap.update',$portfolio->port_id)}}" method="post" enctype="multipart/form-data">
      @csrf
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                <input class="form-control" type="text" placeholder="Nhập tên Nhà Cung Cấp" name="name" value="{{$portfolio ->port_name}}">
              </div>
            </div>
            <div class="mb-3 row">
              <label class="col-sm-3 col-form-label">Xuất Xứ</label>
              <div class="col-sm-9">
                <input class="form-control" type="text" placeholder="Nhập Xuất Xứ" name="origin" value="{{$portfolio ->port_origin}}">
              </div>
            </div>
            <div class="mb-3 row">
              <label class="col-sm-3 col-form-label">Chi Tiết</label>
              <div class="col-sm-9">
                <textarea class="form-control" rows="5" cols="5" placeholder="Nội dung chi tiết..." name="description">{{$portfolio->port_description}}</textarea>
              </div>
            </div>
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                ...
                <div style="padding-top:10px">
                  <img src="{{URL::to('/') }}/server/assets/image/portfolio/{{ $portfolio->port_img }}" alt="">
                  <br>
                  <label for="img" style="text-align:center">{{$portfolio->port_img}}</label>
                </div>
