        ...
        <div class="row">
          <div class="col">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                <textarea class="form-control" id="ckeditor1" rows="5" cols="5" placeholder="Nội dung chi tiết..." name="description">{{$cate->cate_description}}</textarea>
              </div>
            </div>
            <div class="mb-3 row">
              <label class="col-sm-3 col-form-label">Chọn ảnh</label>
              <div class="col-sm-9">
                <input class="form-control" type="file" name="img" data-bs-original-title="" title="" value="{{ URL::to('/') }}/server/assets/images/productcategory/{{ $cate->img }}">
                <img src="{{URL::to('/') }}/server/assets/image/category/{{ $cate->cate_img }}" width="250" height="100" alt="">
                <label for="img">{{$cate->cate_img}}</label>
              </div>
            </div>
          </div>
        </div>
